        ...
        <div className='w-[700px] h-[500px] rounded-[20px] rounded-br-[120px] bg-[white]'>
            <div className='w-[85%] h-[30%] border-b-[3px] mx-auto relative'>
                <div
                    ...
                    className={`absolute w-[80px] h-[80px] rounded-[50%] flex items-center justify-center left-[87%] top-[75%] cursor-pointer ${buttonClicked ? 'bg-violet-500' : 'bg-black'}`}
                >
                ...
                <div className='w-[100%] h-[100%] flex items-center gap-[30px]'>
                    <div className='flex flex-col justify-center h-[100%] w-[20%]'>
                        ...
                        <input
                            className={`text-[30px] font-bold w-[130px] h-[60px] border mt-[5px] rounded-[5px] outline-none pl-[5px] ${errors.day ? 'border-red-500' : 'border-gray-400'}`}
                            type="number"
                            placeholder='DD'
                            value={day}
                    ...
                    <div className='flex flex-col justify-center h-[100%] w-[20%]'>
                        ...
                        <input
                            className={`text-[30px] w-[130px] font-bold h-[60px] border mt-[5px] rounded-[5px] outline-none pl-[5px] ${errors.month ? 'border-red-500' : 'border-gray-400'}`}
                            type="number"
                            placeholder='MM'
                            value={month}
                    ...
                    <div className='flex flex-col justify-center h-[100%] w-[20%]'>
                        ...
                        <input
                            className={`text-[30px] w-[130px] font-bold h-[60px] border mt-[5px] rounded-[5px] outline-none pl-[5px] ${errors.year ? 'border-red-500' : 'border-gray-400'}`}
                            type="number"
                            placeholder='YYYY'
                            value={year}
